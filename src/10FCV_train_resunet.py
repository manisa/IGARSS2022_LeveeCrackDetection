...
from archs.resunet import ResUNet
...
for train_index, test_index in kfold.split(image_indices):
	...
	#save_arc = file_path + "/modelsummary.txt"
	...
	with strategy.scope():
		...
		model = ResUNet(input_filters=16, height=img_height, width=img_width, n_channels=3)
	...
	best_model = ResUNet(input_filters=16, height=img_height, width=img_width, n_channels=3)
